                ...
                if state.get_turn() > 12:  # Se as peças estiverem todas colocadas
                    ...
                    while moves != 0:  # Enquanto houver movimentos
                        ...
                        while not can_move and len(pieces) != 0:
                            ...
                            if option != 2 and (col != 5 and (state.get_grid()[row][col + 1] == -1 or (state.get_grid()[row][col + 1] != -1 and moves == 1))):
                                can_move = True
                                ative_option3 = True
                        ...
                        if can_move:  # Se for possivel mover a peça
                            ...
                            # Se a opção escolhida for 1 e esta optionção estiver disponivel
                            ...
                            # Se a opção escolhida for 2 e esta optionção estiver disponivel
                            ...
                            # Se a opção escolhida for 3 e esta optionção estiver disponivel
                            ...
                            # Se a opção escolhida for 4 e esta optionção estiver disponivel
